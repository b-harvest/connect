...
type GetSanctionListRequest struct {
}

func (m *GetSanctionListRequest) Reset()         { *m = GetSanctionListRequest{} }
func (m *GetSanctionListRequest) String() string { return proto.CompactTextString(m) }
func (*GetSanctionListRequest) ProtoMessage()    {}
func (*GetSanctionListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_85b187574238e3d2, []int{6}
}
func (m *GetSanctionListRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetSanctionListRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetSanctionListRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GetSanctionListRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetSanctionListRequest.Merge(m, src)
}
func (m *GetSanctionListRequest) XXX_Size() int {
	return m.Size()
}
func (m *GetSanctionListRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetSanctionListRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GetSanctionListRequest proto.InternalMessageInfo

type GetSanctionListResponse struct {
	SanctionList []string `protobuf:"bytes,1,rep,name=sanction_list,json=sanctionList,proto3" json:"sanction_list,omitempty"`
}

func (m *GetSanctionListResponse) Reset()         { *m = GetSanctionListResponse{} }
func (m *GetSanctionListResponse) String() string { return proto.CompactTextString(m) }
func (*GetSanctionListResponse) ProtoMessage()    {}
func (*GetSanctionListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_85b187574238e3d2, []int{7}
}
func (m *GetSanctionListResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetSanctionListResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetSanctionListResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GetSanctionListResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetSanctionListResponse.Merge(m, src)
}
func (m *GetSanctionListResponse) XXX_Size() int {
	return m.Size()
}
func (m *GetSanctionListResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetSanctionListResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetSanctionListResponse proto.InternalMessageInfo

func (m *GetSanctionListResponse) GetSanctionList() []string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*GetSanctionListRequest)(nil), "connect.oracle.v2.GetSanctionListRequest")
	proto.RegisterType((*GetSanctionListResponse)(nil), "connect.oracle.v2.GetSanctionListResponse")
...
var fileDescriptor_85b187574238e3d2 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	GetSanctionList(ctx context.Context, in *GetSanctionListRequest, opts ...grpc.CallOption) (*GetSanctionListResponse, error)
...
func (c *queryClient) GetSanctionList(ctx context.Context, in *GetSanctionListRequest, opts ...grpc.CallOption) (*GetSanctionListResponse, error) {
	out := new(GetSanctionListResponse)
	err := c.cc.Invoke(ctx, "/connect.oracle.v2.Query/GetSanctionList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	GetSanctionList(context.Context, *GetSanctionListRequest) (*GetSanctionListResponse, error)
	// Get the mapping of currency pair ID -> currency pair. This is useful for
	// indexers that have access to the ID of a currency pair, but no way to get
	// the underlying currency pair from it.
...
func (*UnimplementedQueryServer) GetSanctionList(ctx context.Context, req *GetSanctionListRequest) (*GetSanctionListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSanctionList not implemented")
}
...
func _Query_GetSanctionList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSanctionListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).GetSanctionList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connect.oracle.v2.Query/GetSanctionList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).GetSanctionList(ctx, req.(*GetSanctionListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSanctionList",
			Handler:    _Query_GetSanctionList_Handler,
		},
		{
...
func (m *GetSanctionListRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetSanctionListRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSanctionListRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GetSanctionListResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetSanctionListResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetSanctionListResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.SanctionList) > 0 {
		for iNdEx := len(m.SanctionList) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintQuery(dAtA, i, uint64(len(m.SanctionList[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *GetSanctionListRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSanctionListResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetSanctionListRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetSanctionListRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetSanctionListRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *GetSanctionListResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetSanctionListResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetSanctionListResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
