...
type GenesisState struct {
	...
	SanctionList []SanctionItem `protobuf:"bytes,3,rep,name=sanction_list,json=sanctionList,proto3" json:"sanction_list"`
}
...
func (*GenesisState) Descriptor() ([]byte, []int) {
	return fileDescriptor_a688f927817fa7da, []int{4}
}
...
func (m *GenesisState) GetSanctionList() []SanctionItem {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*SanctionItem)(nil), "connect.oracle.v2.SanctionItem")
...
var fileDescriptor_a688f927817fa7da = []byte{
	...
	,
}
