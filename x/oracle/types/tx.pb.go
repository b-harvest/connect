...
type MsgAddToSanctionList struct {
	// set of CurrencyPairs to be added to the module (+ prices if they are to be
	// set)
	Signer       string        `protobuf:"bytes,1,opt,name=signer,proto3" json:"signer,omitempty"`
	SanctionItem *SanctionItem `protobuf:"bytes,2,opt,name=sanction_item,json=sanctionItem,proto3" json:"sanction_item,omitempty"`
}

func (m *MsgAddToSanctionList) Reset()         { *m = MsgAddToSanctionList{} }
func (m *MsgAddToSanctionList) String() string { return proto.CompactTextString(m) }
func (*MsgAddToSanctionList) ProtoMessage()    {}
func (*MsgAddToSanctionList) Descriptor() ([]byte, []int) {
	return fileDescriptor_83be677051d99dbe, []int{4}
}
func (m *MsgAddToSanctionList) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgAddToSanctionList) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgAddToSanctionList.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgAddToSanctionList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgAddToSanctionList.Merge(m, src)
}
func (m *MsgAddToSanctionList) XXX_Size() int {
	return m.Size()
}
func (m *MsgAddToSanctionList) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgAddToSanctionList.DiscardUnknown(m)
}

var xxx_messageInfo_MsgAddToSanctionList proto.InternalMessageInfo

type MsgAddToSanctionListResponse struct {
}

func (m *MsgAddToSanctionListResponse) Reset()         { *m = MsgAddToSanctionListResponse{} }
func (m *MsgAddToSanctionListResponse) String() string { return proto.CompactTextString(m) }
func (*MsgAddToSanctionListResponse) ProtoMessage()    {}
func (*MsgAddToSanctionListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_83be677051d99dbe, []int{5}
}
func (m *MsgAddToSanctionListResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgAddToSanctionListResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgAddToSanctionListResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgAddToSanctionListResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgAddToSanctionListResponse.Merge(m, src)
}
func (m *MsgAddToSanctionListResponse) XXX_Size() int {
	return m.Size()
}
func (m *MsgAddToSanctionListResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgAddToSanctionListResponse.DiscardUnknown(m)
}

var xxx_messageInfo_MsgAddToSanctionListResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*MsgAddToSanctionList)(nil), "connect.oracle.v2.MsgAddToSanctionList")
	proto.RegisterType((*MsgAddToSanctionListResponse)(nil), "connect.oracle.v2.MsgAddToSanctionListResponse")
}
...
var fileDescriptor_83be677051d99dbe = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	AddToSanctionList(ctx context.Context, in *MsgAddToSanctionList, opts ...grpc.CallOption) (*MsgAddToSanctionListResponse, error)
}
...
func (c *msgClient) AddToSanctionList(ctx context.Context, in *MsgAddToSanctionList, opts ...grpc.CallOption) (*MsgAddToSanctionListResponse, error) {
	out := new(MsgAddToSanctionListResponse)
	err := c.cc.Invoke(ctx, "/connect.oracle.v2.Msg/AddToSanctionList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	AddToSanctionList(context.Context, *MsgAddToSanctionList) (*MsgAddToSanctionListResponse, error)
}
...
func (*UnimplementedMsgServer) AddToSanctionList(ctx context.Context, req *MsgAddToSanctionList) (*MsgAddToSanctionListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddToSanctionList not implemented")
}
...
func _Msg_AddToSanctionList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgAddToSanctionList)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).AddToSanctionList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/connect.oracle.v2.Msg/AddToSanctionList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).AddToSanctionList(ctx, req.(*MsgAddToSanctionList))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddToSanctionList",
			Handler:    _Msg_AddToSanctionList_Handler,
		},
	},
...
func (m *MsgAddToSanctionList) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgAddToSanctionList) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgAddToSanctionList) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.SanctionItem != nil {
		{
			size, err := m.SanctionItem.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MsgAddToSanctionListResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgAddToSanctionListResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgAddToSanctionListResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgAddToSanctionList) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.SanctionItem != nil {
		l = m.SanctionItem.Size()
		n += 1 + l + sovTx(uint64(l))
	}
	return n
}

func (m *MsgAddToSanctionListResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgAddToSanctionList) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgAddToSanctionList: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgAddToSanctionList: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SanctionItem", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SanctionItem == nil {
				m.SanctionItem = &SanctionItem{}
			}
			if err := m.SanctionItem.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *MsgAddToSanctionListResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgAddToSanctionListResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgAddToSanctionListResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
